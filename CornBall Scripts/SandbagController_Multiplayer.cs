...
/// <summary>
/// A version of the SandbagController adapted for the multiplayer mode.
/// It reports its final state to the MultiplayerGameManager instead of handling logic itself.
/// This script should be on BOTH player bag prefabs.
/// </summary>
[RequireComponent(typeof(Rigidbody))]
public class SandbagController_Multiplayer : MonoBehaviour
{
    ...
    {
        float normalizedDistance = swipeDistance / Screen.height;
        float swipeVelocity = normalizedDistance / swipeTime;
    ...
    private IEnumerator CheckIfStable()
    {
        ...
        MultiplayerGameManager.Instance.RecordThrow(pointsForThisThrow, this.gameObject);
